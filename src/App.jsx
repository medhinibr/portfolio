...
export default function App() {
  ...
  return (
    <div className={`relative min-h-screen font-sans transition-colors duration-300 overflow-x-hidden ${theme === 'dark' ? 'bg-black text-zinc-100' : 'bg-white text-zinc-900'
      ...
      {/* Identity Section */}
      <section id="identity" className="min-h-screen flex flex-col justify-center px-6 sm:px-16 py-24 border-t border-white/5 max-w-6xl mx-auto">
      ...
      <section id="skills" className="min-h-screen flex flex-col justify-center px-6 sm:px-16 py-24 border-t border-white/5 max-w-6xl mx-auto">
        <div className="space-y-4 mb-16 text-left">
          <div className="inline-block text-xs font-bold font-mono tracking-widest text-indigo-400 uppercase">
      ...
      <section id="works" className="min-h-screen flex flex-col justify-center px-6 sm:px-16 py-24 border-t border-white/5 max-w-6xl mx-auto">
        <div className="space-y-4 mb-16 text-left">
          <div className="inline-block text-xs font-bold font-mono tracking-widest text-indigo-400 uppercase">
            SELECTED WORKS
          </div>
      ...
      <section id="timeline" className="min-h-screen flex flex-col justify-center px-6 sm:px-16 py-24 border-t border-white/5 max-w-6xl mx-auto">
        <div className="space-y-4 mb-16 text-left">
          <div className="inline-block text-xs font-bold font-mono tracking-widest text-indigo-400 uppercase">
